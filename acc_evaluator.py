...
import numpy as np
import sys
#sys.path.append('/media/data/fengsy/compression-main/lm-evaluation-harness')
sys.path.append('./lm-evaluation-harness')
#sys.path.append('/home/shzhanggroup/hailab/code/compression-main/lm-evaluation-harness')
...
def run_lm_eval(model, limit, batch_size=16, task_names=["openbookqa", "arc_easy", "winogrande", "hellaswag",
